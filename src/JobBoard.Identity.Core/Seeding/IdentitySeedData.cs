...
/// credentials, so a reviewer can sign in and exercise the app without registering. Idempotent — it
/// no-ops once any account exists. The well-known ids are duplicated (as plain Guids) in the other
