...
[Adding an Endpoint by Hand](./adding-an-endpoint-manually.md) teaches the pattern generically (worked
...
`SELECT`-then-check before the insert?** This is the concurrency shape `docs/adding-an-endpoint-manually.md`
...
Ready to add a new endpoint of your own? [Adding an Endpoint by Hand](./adding-an-endpoint-manually.md)
