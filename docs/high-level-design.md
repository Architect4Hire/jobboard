...
This HLD documents the target design; the current build is an **excellent spike with real, named holes**. The authoritative, ranked list and sequencing live in [`docs/ongoing-architecture-plan.md`](./ongoing-architecture-plan.md). In brief:
