...
- **Related:** ADR-0006 (gateway), ADR-0007 (JWT), ADR-0011 (BOLA/IDOR remediation — the broader, still-Proposed fix this carves the mechanism from), ADR-0013 (events carry the actor), ADR-0014 (audit trail needs the actor), `docs/high-level-design.md` §8.1
