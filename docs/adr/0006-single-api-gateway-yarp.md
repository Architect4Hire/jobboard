...
- **Related:** ADR-0007 (JWT at the edge), ADR-0008 (Aspire wiring), ADR-0011 (identity propagation — proposed), `docs/design/high-level-design.md` §4, §8.1, `.claude/rules/gateway.md`
