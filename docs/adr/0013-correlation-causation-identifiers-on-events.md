...
- **Related:** ADR-0002 (events), ADR-0010 (contracts leaf), ADR-0015 (actor projection mechanism), ADR-0011 (identity remediation), ADR-0014 (audit trail), `docs/design/high-level-design.md` §6
