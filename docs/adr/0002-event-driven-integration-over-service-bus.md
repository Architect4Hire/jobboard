...
- **Related:** ADR-0001 (database-per-service), ADR-0003 (outbox), ADR-0004 (inbox), ADR-0010 (contracts leaf), `docs/design/high-level-design.md` §6, `.claude/rules/messaging.md`
