...
- **Related:** ADR-0001 (database-per-service), ADR-0002 (events), ADR-0004 (idempotent inbox), ADR-0012 (cross-service read model), ADR-0013 (correlation/causation ids), ADR-0015 (actor projection), ADR-0011 (identity remediation), `docs/design/high-level-design.md` §6, §8.1
