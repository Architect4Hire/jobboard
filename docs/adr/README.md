...
See also: [`docs/design/high-level-design.md`](../design/high-level-design.md) (design narrative), [`CLAUDE.md`](../../CLAUDE.md) (enforceable ruleset), [`docs/design/ongoing-architecture-plan.md`](../design/ongoing-architecture-plan.md) (review & 30/60/90 plan).
