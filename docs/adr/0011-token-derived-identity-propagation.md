...
- **Related:** ADR-0006 (gateway), ADR-0007 (JWT), ADR-0015 (the projection *mechanism*, carved out and Accepted for audit attribution), ADR-0013 / ADR-0014 (the audit trail that depends on the actor), `docs/design/high-level-design.md` §8.1, `docs/design/ongoing-architecture-plan.md` §5.1 (risks #1–2)
...
This ADR is **Proposed** and corresponds to the 30-day, ship-blocking items in `docs/design/ongoing-architecture-plan.md` §9.
