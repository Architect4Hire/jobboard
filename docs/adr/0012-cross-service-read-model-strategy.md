...
- **Related:** ADR-0001 (database-per-service), ADR-0002 (events), `docs/high-level-design.md` §10–11, `docs/ongoing-architecture-plan.md` §1, §9 (90-day item #15)
...
This ADR is **Proposed** and corresponds to 90-day plan item #15 in `docs/ongoing-architecture-plan.md`. Promote to **Accepted** once the default strategy and escalation rule are chosen and applied to the first real cross-service screen.
