...
- **How to actually build a slice** → [Adding an Endpoint by Hand](../developer/adding-an-endpoint-manually.md) and the [`add-endpoint`](../../.claude/skills/) / [`add-component`](../../.claude/skills/) skills.
