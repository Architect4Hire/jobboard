...
sequence is in `docs/prompts/scrub-prompts.md` — run Part 1 in order to stand the system up.
...
no-ops until those tools and the projects exist. `docs/prompts/scrub-prompts.md` is how you create `src/`.
