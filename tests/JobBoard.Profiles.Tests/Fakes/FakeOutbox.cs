...
/// <see cref="ThrowOnEnqueue"/> is set, fails inside the transaction so a test can prove rollback (the
/// profile write and its outbox row commit or roll back together).
/// </summary>
